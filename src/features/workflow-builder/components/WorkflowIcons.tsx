...
export const WorkflowIcons: Record<string, React.FC<IconProps>> = {
  ...
  // Action 16: Send List (WhatsApp green speech bubble)
  send_list: ({ size = 16, className = '', ...props }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
    ...
    >
      <path
        d="M12 2C6.48 2 2 6.48 2 12c0 1.95.56 3.77 1.53 5.31L2.1 21.9l4.72-1.42A9.94 9.94 0 0 0 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2z"
        fill="#25D366"
      />
      <path
        d="M16.8 14.3c-.27-.13-1.6-.79-1.85-.88-.25-.09-.43-.13-.61.13-.18.27-.7 1.25-.86 1.43-.16.18-.32.2-.59.07-.27-.13-1.14-.42-2.17-1.34-.8-.72-1.34-1.6-1.5-1.87-.16-.27-.02-.42.12-.55.12-.12.27-.31.4-.47.13-.16.18-.27.27-.45.09-.18.04-.34-.02-.47-.07-.13-.61-1.46-.83-2-.22-.52-.44-.45-.61-.46l-.52-.01c-.18 0-.47.07-.72.34-.25.27-.95.93-.95 2.26 0 1.33.97 2.62 1.1 2.8.13.18 1.91 2.92 4.63 4.09.65.28 1.15.45 1.54.57.65.21 1.24.18 1.71.11.52-.08 1.6-.65 1.82-1.28.22-.63.22-1.17.16-1.28-.06-.11-.25-.18-.52-.32z"
        fill="#FFFFFF"
      />
    </svg>
  ),

  // Action 17: Send Non Template (WhatsApp green speech bubble)
  send_non_template: ({ size = 16, className = '', ...props }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  // Action 18: Send Interactive (WhatsApp green speech bubble)
  send_interactive: ({ size = 16, className = '', ...props }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
