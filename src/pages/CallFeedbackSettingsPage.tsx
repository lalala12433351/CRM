...
export const CallFeedbackSettingsPage: React.FC<CallFeedbackSettingsViewProps> = ({
  activeAgent,
  onShowToast
}) => {
...
export const CallFeedbackSettingsView = CallFeedbackSettingsPage;
export default CallFeedbackSettingsPage;
