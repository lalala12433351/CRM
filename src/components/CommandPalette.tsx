...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const navigationItems = [
    ...
    { id: 'nav-copilot', type: 'action', title: 'Open AI Sales Copilot', subtitle: 'Objection handling, instant pitches, and battlecards', icon: MessageSquare, action: () => onOpenAiCopilot() },
    { id: 'nav-voicebot', type: 'action', title: 'Run AI Voice Bot Simulator', subtitle: 'Autonomous outbound qualification call agent', icon: PhoneCall, action: () => onOpenVoiceBot() },
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 flex items-start justify-center pt-20 px-4 animate-in fade-in duration-150 font-sans">
      <div 
